...
export function Home() {
    const { products, addProduct, updateStatus, deleteProduct } = useProductContext();
    ...
    const applyFilterAndSort = (product: ProductProps) => {
        ...
        if (product.status === "rejected" || product.status === "delete_pending") return false;
    ...
    const handleDelete = async (id: string) => {
      try {
        await updateStatus(id, "delete_pending");
    ...
    const sortedAndFilteredProducts = products
        ...
        const visibleProducts = sortedAndFilteredProducts.filter(product => product.status !== "delete_pending");
